...
export default async function sitemap() {
  ...
  try {
    ...
    return [
      { url: "https://Veeshow.com", lastModified: new Date().toISOString(), priority: 1 },
      ...post,
      ...post2
    ];
  } catch (error) {
